...
let Categories = class Categories {
    static _OPENAPI_METADATA_FACTORY() {
        return { id: { required: true, type: () => String, description: "UUID generated automatically" }, name: { required: true, type: () => String, description: "Category name, maximum 50 characters and unique value" }, products: { required: true, type: () => [require("./products.entity").Products] } };
    }
};
